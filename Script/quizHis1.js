const questions = [
    ...
    {
        question: "Quem foi o líder do movimento que proclamou a independência do Brasil?",
        options: [
            "Dom Pedro I",
            "Tiradentes",
            "Getúlio Vargas", 
    ...
    {
        qquestion: "Qual evento marcou o fim da monarquia no Brasil e o início da república?",
        options: [
            "Independência do Brasil",
            "Revolução de 1930",
            "Proclamação da República", 
            "Descobrimento do Brasil"],
        correct: "Proclamação da República"
    },
    {
        ...
        options: [
            ...
            "Dom Pedro I"],
        correct: "Marechal Deodoro da Fonseca"
    },
    {
        question: "Qual desses movimentos foi uma revolta popular contra os altos impostos durante o Brasil colonial?",
        options: [
            "Revolta dos Malês",
            "Guerra de Canudos",
...
function copyText() {
    const message = "Acertei " + score + " de " + questions.length + " perguntas nesse quiz sobre a Independência do Brasil!" + "Vem cá testar seus conhecimentos também! https://www.tecestude.com";
    ...
    if (navigator.share) {
        try {
            await navigator.share({
                title: "Acertei " + score + " de " + questions.length + " perguntas nesse quiz a Independência do Brasil!" + "Vem cá testar seus conhecimentos também!",
