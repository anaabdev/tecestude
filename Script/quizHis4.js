const questions = [
    {
        question: "Em que ano ocorreu a chegada dos portugueses ao Brasil?",
        options: [
            "1492",
            "1500",
            "1530", 
    ...
    {
        question: "Qual navegador português é considerado o responsável pela chegada ao Brasil?",
        options: [
            "Vasco da Gama",
    ...
    {
        question: "Qual foi o nome da primeira terra avistada pelos portugueses no Brasil?",
        options: [
            "Ilha de Vera Cruz",
            "Ponta do Seixas",
            "Porto Seguro", 
            "Monte Pascoal"],
        correct: "Monte Pascoal"
    },
    {
        question: "Qual era o nome do rei de Portugal durante o descobrimento do Brasil?",
        options: [
            "Dom Pedro I",
            "Dom Manuel I",
            "Dom João VI", 
            "Dom Afonso V"],
        correct: "Dom Manuel I"
    },
    {
        question: "Qual era o principal objetivo da expedição de Pedro Álvares Cabral quando chegou ao Brasil?",
        options: [
            "Conquistar terras na América",
            "Encontrar um caminho marítimo para as Índias",
            "Escravizar os povos indígenas", 
            "Fundar colônias portuguesas"],
        correct: "Encontrar um caminho marítimo para as Índias"
    }
];
...
function copyText() {
    const message = "Acertei " + score + " de " + questions.length + " perguntas nesse quiz sobre o 'descobrimento' do Brasil!" + "Vem cá testar seus conhecimentos também! https://www.tecestude.com";
    ...
    if (navigator.share) {
        try {
            await navigator.share({
                title: "Acertei " + score + " de " + questions.length + " perguntas nesse quiz sobre o 'descobrimento' do Brasil!" + "Vem cá testar seus conhecimentos também!",
