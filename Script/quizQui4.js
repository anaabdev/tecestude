const questions = [
    {
        question: "O que representa o número atômico de um elemento na tabela periódica?",
        options: [
            "A quantidade de nêutrons no núcleo do átomo",
            "O número total de elétrons em um átomo",
            "A quantidade de prótons no núcleo de um átomo", 
            "A massa atômica do elemento"],
        correct: "A quantidade de prótons no núcleo de um átomo"
    },
    {
        question: "Quais são os dois principais tipos de elementos que podemos encontrar na tabela periódica?",
        options: [
            "Metais e gases nobres",
            "Metais e não-metais",
            "Não-metais e semimetais", 
            "Metais e ligas"],
        correct: "Metais e não-metais"
    },
    {
        question: "Como os elementos em um mesmo grupo da tabela periódica estão relacionados?",
        options: [
            "Têm o mesmo número de prótons",
            "Têm o mesmo número de nêutrons",
            "Têm o mesmo número de elétrons na camada de valência", 
            "Têm a mesma massa atômica"],
        correct: "Têm o mesmo número de elétrons na camada de valência"
    },
    {
        question: "O que é um símbolo químico e como ele é usado na tabela periódica?",
        options: [
            "Uma representação gráfica dos elementos que indica a sua forma física",
            "Uma abreviação de uma ou duas letras que representa um elemento na tabela periódica",
            "Um número que indica a quantidade de um elemento em uma reação química", 
            "Uma fórmula que descreve a estrutura de um composto químico"],
        correct: "Uma abreviação de uma ou duas letras que representa um elemento na tabela periódica"
    },
    {
        question: "Por que a tabela periódica é uma ferramenta importante para os químicos?",
        options: [
            "Porque mostra a temperatura de fusão de todos os elementos",
            "Porque organiza os elementos para fácil comparação de suas propriedades",
            "Porque lista todos os compostos conhecidos", 
            "Porque indica a cor de cada elemento"],
        correct: "Porque organiza os elementos para fácil comparação de suas propriedades"
    }
];
