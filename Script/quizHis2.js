const questions = [
    {
        question: "Em que ano Getúlio Vargas assumiu o poder pela primeira vez no Brasil?",
        options: [
            "1922",
            "1930",
            "1937", 
    ...
    {
        question: "Qual evento marcou a ascensão de Getúlio Vargas ao poder?",
        options: [
            "Revolução de 1932",
            "Proclamação da República",
            "Revolução de 1930", 
            "Golpe Militar de 1964"],
        correct: "Revolução de 1930"
    },
    {
        question: "Qual foi o nome do regime autoritário instituído por Vargas em 1937?",
        options: [
            "Estado Novo",
            "República Nova",
            "Ditadura Militar", 
    ...
    {
        question: "Qual foi uma das principais conquistas trabalhistas de Getúlio Vargas durante seu governo?",
        options: [
            "Criação do salário mínimo",
            "Privatização das estatais",
            "Redução dos direitos trabalhistas", 
            "Criação do Plano Real"],
        correct: "Criação do salário mínimo"
    },
    {
        question: "Em que ano Getúlio Vargas se suicidou, encerrando seu segundo mandato como presidente?",
        options: [
            "1945",
            "1954",
            "1961", 
...
function copyText() {
    const message = "Acertei " + score + " de " + questions.length + " perguntas nesse quiz sobre a Era Vargas!" + "Vem cá testar seus conhecimentos também! https://www.tecestude.com";
    ...
    if (navigator.share) {
        try {
            await navigator.share({
                title: "Acertei " + score + " de " + questions.length + " perguntas nesse quiz sobre a Era Vargas!" + "Vem cá testar seus conhecimentos também!",
